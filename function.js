...
function calculateResult(expertise, generated) {
    
    console.log("Bom:",(20 - Math.ceil(expertise / 3) - ((expertise % 2) + 1)))
    

    if (generated >= (20 - Math.ceil(expertise / 5) + 1)) {
        return "Extremo";
    } else if(generated >= (20 - Math.ceil(expertise / 3) - ((expertise % 2) - 1))) {
        return "Bom";
    } else if (expertise >= 20 || generated >= (20 - Math.ceil(expertise / 2) - 2)) {
        return "Normal";
    } else if (generated === 1) {
        return "Desastre";
    } else {
...
function calcd20(){
    var expertise = Number(document.getElementById("number").value);
    if(false){
        ...
        // desastre = 1
        // normal = x > math.ceil(pericia / 2)
        // bom = x > pericia + (20 - math.ceil(pericia / 3))
        //extremo = x > percia + (20 - math.ceil(pericia / 5))

        const label = calculateResult(expertise, random);
        ...
        //     break;
        // }
        addTable(expertise, random, label);
